...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5866305160:AAEcXgdVYvkkWQVBB1CWivO2S8Bzy3MOE9E"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Guchatgptbot'
username = 'Guchatgptboths_bot'
